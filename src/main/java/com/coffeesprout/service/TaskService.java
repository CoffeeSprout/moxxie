...
public class TaskService {
    ...
    public TaskStatusDetailResponse getTaskStatus(String upid, @AuthTicket String ticket) {
        ...
        try {
            ...
            if (response == null || !response.has("data")) {
                throw ProxmoxException.notFound("Task", upid,
                    "Task may have expired or UPID format is incorrect");
            }
            ...
            throw ProxmoxException.internalError("get task status for UPID " + upid, e);
        }
    }
    ...
    public TaskLogResponse getTaskLog(String upid, Integer start, Integer limit, @AuthTicket String ticket) {
        ...
        try {
            ...
            throw ProxmoxException.internalError("get task log for UPID " + upid, e);
        }
    }
    ...
    public TaskListResponse listTasks(String node, String typeFilter, String statusFilter,
        ...
        try {
            ...
            throw ProxmoxException.internalError("list tasks", e);
        }
    }
    ...
    public void stopTask(String upid, @AuthTicket String ticket) {
        ...
        try {
            ...
            throw ProxmoxException.internalError("stop task " + upid, e);
        }
    }
