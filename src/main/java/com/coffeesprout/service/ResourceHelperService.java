...
public class ResourceHelperService {
    ...
    public int suggestNextVMId(int startFrom, @AuthTicket String ticket) {
        ...
        if (nextId > VMConstants.Resources.MAX_VM_ID) {
            throw ProxmoxException.resourceLimitExceeded("VM IDs",
                VMConstants.Resources.MAX_VM_ID, VMConstants.Resources.MAX_VM_ID)
                .withDetail("suggestion", "All VM IDs in the configured range are in use. Expand the VM ID range in configuration");
        }
