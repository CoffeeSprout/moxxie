...
public record FirmwareConfig(
    ...
    @NotNull(message = "Firmware type is required") FirmwareType type,

    @Schema(description = "Machine type", example = "q35", defaultValue = "pc")
    @NotNull(message = "Machine type is required") MachineType machine,
    ...
    public record EFIDiskConfig(
        ...
        @NotNull(message = "EFI disk storage is required for UEFI VMs") String storage,
