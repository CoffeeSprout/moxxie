...
public record TemplateCloneRequest(
    ...
    @NotNull(message = "Template ID is required") @Min(value = 100, message = "Template ID must be at least 100")
    ...
    @NotNull(message = "New VM ID is required") @Min(value = 100, message = "VM ID must be at least 100")
